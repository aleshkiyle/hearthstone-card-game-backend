...
public enum CardProvider {
    ...
    private void addCards(){
        ...
        cards.add(new Card("Механический голем", 3, "Огромная махина из металла и магии, которая медленно, но верно идет к своей цели.", 1, 4, Spell.SPELL1, 1, CardClass.Machine));
        cards.add(new Card("Механический танк", 3, "Большое механизированное устройство, напоминающее робота и управляемое человеком изнутри.", 2, 3, Spell.SPELL1, 2, CardClass.Machine));
        cards.add(new Card("Железнозубый прыгун", 3, "Воплощение саблезубого тигра в металле, которое также боится воды.", 4, 3, Spell.SPELL1, 3, CardClass.Machine));
        cards.add(new Card("Безумный бот", 3, "Огромный робот, имеющий человекоподобный облик и управляемый компьютером.", 3, 5, Spell.SPELL1, 4, CardClass.Machine));
